...
exports.Accordion = (0, react_1.forwardRef)((_a, ref) => {
    var { options, getPanel } = _a,
        rest = __rest(_a, ['options', 'getPanel']);
    ...
    return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {
        children: options.map((item, index) => {
            return (0, jsx_runtime_1.jsxs)(
                Accordion_1.default,
                Object.assign(
                    { ref: ref, TransitionProps: { unmountOnExit: true } },
                    rest,
                    { expanded: expanded === item.labelId, onChange: handleAccordionOnChange(item.labelId) },
                    {
                        children: [
                            (0, jsx_runtime_1.jsx)(
                                ...
                                Object.assign(
                                    {
                                        ...
                                        expandIcon: (0, jsx_runtime_1.jsx)(ExpandMore_1.default, {})
                                    },
                                    { children: item.summary }
                                )
                            ),
                            (0, jsx_runtime_1.jsx)(AccordionDetails_1.default, { children: item.details })
                        ]
                    }
                ),
                index
