...
const Breadcrumb = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(Breadcrumbs_1.default, Object.assign({ separator: ">" }, rest, { children: options.map((item, index) => {
            ...
            return ((0, jsx_runtime_1.jsx)(Link_1.Link, Object.assign({ color: "secondary", underline: 'hover', to: item.href, component: component }, { children: (0, jsx_runtime_1.jsx)(MUIBreadCrumbText, { children: item.displaytext }) }), index));
        }) })));
};
