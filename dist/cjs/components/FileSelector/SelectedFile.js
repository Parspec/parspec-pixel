...
const SelectedFile = (props) => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (url && !file.filepath)
            ...
            handleResults({ file, progress: 100, s3_file_path: file.filepath }, index);
        return () => {
            if (progress !== 1)
                source.cancel();
        };
