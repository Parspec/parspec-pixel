...
exports.RadioGroup = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(FormControl_1.FormControl, Object.assign({ error: error, ref: ref }, { children: [(0, jsx_runtime_1.jsx)(FormLabel_1.default, { children: label }), (0, jsx_runtime_1.jsx)(RadioGroup_1.default, Object.assign({}, rest, { name: name, sx: { paddingLeft: '1px' } }, { children: options.map((item, index) => ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(FormControlLabel_1.default, { value: item.value, control: (0, jsx_runtime_1.jsx)(Radio_1.Radio, { size: size, disabled: disabled }), label: item.label }, index), item.helper && !rest.row && (0, jsx_runtime_1.jsx)(Box_1.Box, Object.assign({ ml: 8 }, { children: item.helper }))] }))) })), error && (0, jsx_runtime_1.jsx)(material_1.FormHelperText, { children: helperText })] })));
});
