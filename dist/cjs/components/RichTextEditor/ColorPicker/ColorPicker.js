...
function ColorPicker({ color, onChange }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(Box_1.Box, Object.assign({ className: "color-picker-wrapper", width: WIDTH, ref: innerDivRef }, { children: [(0, jsx_runtime_1.jsx)(TextInput_1.default, { label: "Hex", onChange: onSetHex, value: inputColor }), (0, jsx_runtime_1.jsx)(Box_1.Box, Object.assign({ className: "color-picker-basic-color" }, { children: basicColors.map((basicColor) => ((0, jsx_runtime_1.jsx)("button", { className: basicColor === selfColor.hex ? ' active' : '', style: { backgroundColor: basicColor }, onClick: () => {
                    ...
                    } }) })), (0, jsx_runtime_1.jsx)(MoveWrapper, Object.assign({ className: "color-picker-hue", onChange: onMoveHue }, { children: (0, jsx_runtime_1.jsx)(Box_1.Box, { className: "color-picker-hue_cursor", style: {
                        backgroundColor: `hsl(${selfColor.hsv.h}, 100%, 50%)`,
                        left: huePosition.x
                    } }) })), (0, jsx_runtime_1.jsx)(Box_1.Box, { className: "color-picker-color", style: { backgroundColor: selfColor.hex } })] })));
}
...
function MoveWrapper({ className, style, onChange, children }) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ ref: divRef, className: className, style: style, onMouseDown: onMouseDown }, { children: children })));
}
