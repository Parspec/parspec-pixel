...
export default function ToolBar({ onFileUpload, isDisable, showAttachements, showShareableLinkButton, shareableLinkTitle, shareableLinkUrl, showFontFamiliy }: Partial<IRichTextEditorProps>): JSX.Element;
