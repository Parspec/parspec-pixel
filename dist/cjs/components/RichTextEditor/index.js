                        ...
                        { className: 'editor-container' },
                        {
                            children: (0, jsx_runtime_1.jsxs)(
                                ...
                                Object.assign(
                                    ...
                                    {
                                        children: [
                                            (0, jsx_runtime_1.jsx)(ToolBar_1.ToolBar, {
                                            ...
                                            (0, jsx_runtime_1.jsx)(LexicalRichTextPlugin_1.RichTextPlugin, {
                                                contentEditable: (0, jsx_runtime_1.jsx)(LexicalContentEditable_1.ContentEditable, {
                                                    onFocus: onFocus,
                                                    style: {
                                                        width: '100%',
                                                ...
                                                placeholder: (0, jsx_runtime_1.jsx)(PlaceHolder_1.Placeholder, { placeHolderText: placeHolderText }),
                                                ErrorBoundary: LexicalErrorBoundary_1.default
                                            }),
                                            (0, jsx_runtime_1.jsx)(LexicalListPlugin_1.ListPlugin, {}),
                                            (0, jsx_runtime_1.jsx)(LexicalHistoryPlugin_1.HistoryPlugin, {}),
                                            (0, jsx_runtime_1.jsx)(HtmlPlugin_1.HtmlPlugin, { initialHtml: initialHtml, onBlur: onBlur, onChange: onChange }),
                                            (0, jsx_runtime_1.jsx)(AutoLinkPlugin_1.AutoLinkPlugin, {}),
                                            (0, jsx_runtime_1.jsx)(LexicalLinkPlugin_1.LinkPlugin, {}),
                                            (0, jsx_runtime_1.jsx)(LexicalClickableLinkPlugin_1.default, {}),
                                            (0, jsx_runtime_1.jsx)(DisableEditorPlugin_1.DisableEditorPlugin, { isDisable: isDisable }),
                                            (0, jsx_runtime_1.jsx)(LexicalMarkdownShortcutPlugin_1.MarkdownShortcutPlugin, { transformers: markdown_1.TRANSFORMERS })
                                        ]
                                    }
                                )
                            )
