...
function RichTextEditor({ onFileUpload, onChange, initialHtml = '', editorBgColor = 'white', contentEditableHeight = '300px' }) {
    ...
    return ((0, jsx_runtime_1.jsx)(Box_1.Box, Object.assign({ id: 'custom-rich-text-editor' }, { children: (0, jsx_runtime_1.jsx)(LexicalComposer_1.LexicalComposer, Object.assign({ initialConfig: initialConfig }, { children: (0, jsx_runtime_1.jsxs)(Box_1.Box, Object.assign({ className: "editor-container", position: "relative", display: "flex", flexDirection: "column", alignItems: "flex-start" }, { children: [(0, jsx_runtime_1.jsx)(ToolBar_1.default, { onFileUpload: onFileUpload }), (0, jsx_runtime_1.jsxs)(Box_1.Box, Object.assign({ className: "editor-inner", position: "relative" }, { children: [(0, jsx_runtime_1.jsx)(LexicalRichTextPlugin_1.RichTextPlugin, { contentEditable: (0, jsx_runtime_1.jsx)(LexicalContentEditable_1.ContentEditable, { style: {
                                        width: '100%',
