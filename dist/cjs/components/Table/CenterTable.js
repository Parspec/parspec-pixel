...
const CenterTable = ({ table, sortableColumnIds }) => {
    return ((0, jsx_runtime_1.jsxs)(_1.Table, { children: [(0, jsx_runtime_1.jsx)(_1.TableHead, Object.assign({ sx: { backgroundColor: 'secondary.light' } }, { children: table.getCenterHeaderGroups().map((headerGroup) => ((0, jsx_runtime_1.jsx)(_1.TableRow, { children: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: headerGroup.headers.map((header) => {
                            var _a;
...
exports.CenterTable = CenterTable;
