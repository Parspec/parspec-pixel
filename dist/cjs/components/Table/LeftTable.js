...
const LeftTable = ({ table, sortableColumnIds }) => {
    var _a;
    return ((0, jsx_runtime_1.jsxs)(material_1.Table, Object.assign({ style: { borderRight: '1px solid grey' } }, { children: [(0, jsx_runtime_1.jsx)(material_1.TableHead, Object.assign({ style: { width: 'max-content' } }, { children: (_a = table === null || table === void 0 ? void 0 : table.getLeftHeaderGroups()) === null || _a === void 0 ? void 0 : _a.map((headerGroup) => ((0, jsx_runtime_1.jsx)(material_1.TableRow, { children: headerGroup.headers.map((header) => {
                        var _a;
                        return ((0, jsx_runtime_1.jsx)(material_1.TableCell, Object.assign({ padding: header.column.id === 'select' ? 'checkbox' : 'normal', component: 'th', style: { border: '1px solid' }, colSpan: header.colSpan }, { children: header.isPlaceholder ? null : ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: header.column.id !== 'drag' && ((0, jsx_runtime_1.jsx)(Box_1.Box, Object.assign({ component: 'span', style: sortableColumnIds.includes(header.column.id) && header.column.getCanSort()
                                        ...
                                        : {}, onClick: sortableColumnIds.includes(header.column.id) ? header.column.getToggleSortingHandler() : () => { } }, { children: (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Typography_1.BodyMedium, Object.assign({ fontWeight: 600, width: 'max-content' }, { children: (0, react_table_1.flexRender)(header.column.columnDef.header, header.getContext()) })), sortableColumnIds.includes(header.column.id)
                                                ? (_a = {
