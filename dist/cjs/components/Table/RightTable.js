...
const RightTable = ({ table, sortableColumnIds }) => {
    var _a;
    return ((0, jsx_runtime_1.jsxs)(_1.Table, Object.assign({ style: { borderLeft: '1px solid grey' } }, { children: [(0, jsx_runtime_1.jsx)(_1.TableHead, Object.assign({ style: { width: 'max-content' } }, { children: (_a = table === null || table === void 0 ? void 0 : table.getRightHeaderGroups()) === null || _a === void 0 ? void 0 : _a.map((headerGroup) => ((0, jsx_runtime_1.jsx)(_1.TableRow, { children: headerGroup.headers.map((header) => {
                        var _a;
