...
exports.Table = (0, react_1.forwardRef)((props, ref) => {
    ...
    const actionBegin = (e) => {
        ...
        if (e.requestType === 'filterbeforeopen') {
            ...
            if (
                !((_d =
                    (_c = (_b = tableRef === null || tableRef === void 0 ? void 0 : tableRef.current) === null || _b === void 0 ? void 0 : _b.filterModule) === null || _c === void 0
                        ? void 0
                        : _c.filteredResult) === null || _d === void 0
                    ? void 0
                    : _d.length)
            ) {
        ...
        const targetData =
            (_c =
                (_a = tableRef === null || tableRef === void 0 ? void 0 : tableRef.current) === null || _a === void 0
                    ? void 0
                    : _a.getRowInfo((_b = args === null || args === void 0 ? void 0 : args.target) === null || _b === void 0 ? void 0 : _b.parentElement)) === null || _c === void 0
                ? void 0
                : _c.rowData; //dropped data
        let data;
        for (let i = 0; i < args.data.length; i++) {
            ...
            if (notAllowed) {
                if (args.data.length > 1) {
                    alert(
                        'Please note accessories can only be a child of product, product can only be a child of section and section cannot be a child of a product or accessories, please make sure that all your selected items follow the mentioned criteria'
                    );
                    break;
                } else {
                    alert(error);
            ...
            function handleResize(entries) {
                ...
                const toolbarHeight =
                    showToolbar && (toolbarContainerRef === null || toolbarContainerRef === void 0 ? void 0 : toolbarContainerRef.current)
                        ? (_b = toolbarContainerRef === null || toolbarContainerRef === void 0 ? void 0 : toolbarContainerRef.current) === null || _b === void 0
                            ? void 0
                            : _b.clientHeight
                        : 0;
            ...
            { position: 'relative', height: '100%', width: '100%', ref: tableContainerRef },
            {
                children: [
                                    ...
                                    children: [
                                        (0, jsx_runtime_1.jsxs)(
                                            ...
                                            Object.assign(
                                                ...
                                                {
                                                    children: [
                                                        title && (0, jsx_runtime_1.jsx)(Typography_1.BodySmall, Object.assign({ color: 'neutral.dark' }, { children: title })),
                                                                            ...
                                                                            onChange: (t) => {
                                                                                ...
                                                                                t.target.value =
                                                                                    (_b = (_a = t === null || t === void 0 ? void 0 : t.target) === null || _a === void 0 ? void 0 : _a.value) ===
                                                                                        null || _b === void 0
                                                                                        ? void 0
                                                                                        : _b.replace(/[^a-zA-Z0-9-_& ]/g, '');
                                                                                tableRef.current.search(
                                                                                    (_d = (_c = t === null || t === void 0 ? void 0 : t.target) === null || _c === void 0 ? void 0 : _c.value) ===
                                                                                        null || _d === void 0
                                                                                        ? void 0
                                                                                        : _d.replace(/[^a-zA-Z0-9-_& ]/g, '').trim()
                                                                                );
                                                                            }
                                                                        })
                                                                    }
                                                        ...
                                                        (toolBarOptions === null || toolBarOptions === void 0 ? void 0 : toolBarOptions.includes('move')) &&
                                                            (0, jsx_runtime_1.jsx)(
                                                                Tooltip_1.Tooltip,
                                                                Object.assign(
                                                                    { title: disabled ? 'Select Item(s) First' : 'Change Section' },
                                                                    {
                                                                        children: (0, jsx_runtime_1.jsx)(
                                                                            Box_1.Box,
                                                                            Object.assign(
                                                                                { 'data-testid': 'move-btn' },
                                                                                {
                                                                                    children: (0, jsx_runtime_1.jsx)(
                                                                                        IconButton_1.IconButton,
                                                                                        Object.assign(
                                                                                            { onClick: () => onMove(tableRef.current.getSelectedRecords()), disabled: disabled },
                                                                                            { children: (0, jsx_runtime_1.jsx)(Icons_1.MoveDownIcon, { fontSize: 'medium' }) }
                                                                                        )
                                                                                    )
                                                                                }
                                                                            )
                                                                                        ...
                                                                                        Object.assign(
                                                                                            {
                                                                                                ...
                                                                                                onClick: () => {
                                                                                                    var _a;
                                                                                                    onDelete(
                                                                                                        (_a = tableRef === null || tableRef === void 0 ? void 0 : tableRef.current) === null ||
                                                                                                            _a === void 0
                                                                                                            ? void 0
                                                        ...
                                                        (toolBarOptions === null || toolBarOptions === void 0 ? void 0 : toolBarOptions.includes('selectedItems')) &&
                                                            selected > 0 &&
                                                            !selectedItemsBelowSearch &&
                                                            (0, jsx_runtime_1.jsx)(SelectedItemsCount_1.SelectedItemsCount, { count: selected, closeBanner: closeBanner })
                                                    ]
                                                }
                                            )
                                        ),
                    ...
                    (toolBarOptions === null || toolBarOptions === void 0 ? void 0 : toolBarOptions.includes('selectedItems')) &&
                        ...
                        (0, jsx_runtime_1.jsx)(
                            Box_1.Box,
                            Object.assign({ mb: 2, width: 'max-content' }, { children: (0, jsx_runtime_1.jsx)(SelectedItemsCount_1.SelectedItemsCount, { count: selected, closeBanner: closeBanner }) })
                        ),
                    (0, jsx_runtime_1.jsx)(
                        Box_1.Box,
                        Object.assign(
                            { className: 'control-pane' },
                            {
                                children: (0, jsx_runtime_1.jsx)(
                                    Box_1.Box,
                                    Object.assign(
                                        { className: 'control-section', height: height || tableHeight },
                                        {
                                            children:
                                                data &&
                                                (0, jsx_runtime_1.jsxs)(
                                                    ...
                                                    Object.assign(
                                                        ...
                                                        },
                                                        {
                                                            children: [
                                                                ...
                                                                aggregateChildren && (0, jsx_runtime_1.jsx)(ej2_react_treegrid_1.AggregatesDirective, { children: aggregateChildren }),
                                                                (0, jsx_runtime_1.jsx)(ej2_react_treegrid_1.Inject, {
                                                                    services: [
                                                                        ...
                                                                        ej2_react_treegrid_1.Aggregate
                                                                    ]
                                                                })
                                                            ]
                                                        }
