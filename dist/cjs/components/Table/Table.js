...
exports.Table = (0, react_1.forwardRef)((props, ref) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Box_1.Box, Object.assign({ onClick: () => ref.hideUnhide({
                    id: 3,
                    taskID: 3,
                    name: 'accessory1',
                    reporter: 'Forest',
