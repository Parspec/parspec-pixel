...
exports.Table = (0, react_1.forwardRef)((props, ref) => {
    ...
    const actionComplete = (args) => {
        ...
        if ((args === null || args === void 0 ? void 0 : args.requestType) !== 'refresh' && (args === null || args === void 0 ? void 0 : args.requestType) !== 'paging' && (args === null || args === void 0 ? void 0 : args.requestType) !== 'searching' && (0, ej2_base_1.isNullOrUndefined)(args.data)) {
            isEscPressed = true;
        }
        // tableRef.current.grid.notify('freezerender', { case: 'refreshHeight' });
    };
