...
exports.TextField = (0, react_1.forwardRef)((_a, ref) => {
    var { variant, color, error, size, label, chips, onChipDelete, helperText, icon, startIcon, scrollAreaHeight } = _a, rest = __rest(_a, ["variant", "color", "error", "size", "label", "chips", "onChipDelete", "helperText", "icon", "startIcon", "scrollAreaHeight"]);
