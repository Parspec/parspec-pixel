...
export const Autocomplete = forwardRef((_a, ref) => {
    ...
    return (_jsx(_Fragment, { children: _jsx(MUIAutocomplete, Object.assign({ fullWidth: true }, props, { options: options, ref: ref, sx: sx, id: id, onBlur: handleFocusOut, onChange: handleOnChange, getOptionLabel: (option) => {
                ...
                return (_jsx(TextField, Object.assign({ size: fieldSize, helperText: helperText, error: error }, params, { variant: variant, color: color, label: label, placeholder: placeholder, autoFocus: autoFocus, inputProps: Object.assign(Object.assign({}, params.inputProps), { maxLength }) })));
            }, disabled: disabled })) }));
});
