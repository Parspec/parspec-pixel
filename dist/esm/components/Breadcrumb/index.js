...
export const Breadcrumb = (_a) => {
    ...
    return (_jsx(MUIBreadcrumb, Object.assign({ separator: ">" }, rest, { children: options.map((item, index) => {
            ...
            return (_jsx(Link, Object.assign({ color: "secondary", underline: 'hover', to: item.href, component: component }, { children: _jsx(MUIBreadCrumbText, { children: item.displaytext }) }), index));
        }) })));
};
