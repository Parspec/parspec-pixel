...
export default function FontSize({ selectionFontSize, disabled, editor }) {
     ...
     */
    const updateFontSizeInSelection = useCallback((newFontSize, updateType) => {
