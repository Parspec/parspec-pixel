                                    ...
                                    { className: 'editor-inner' },
                                    {
                                        children: [
                                            ...
                                            _jsx(RichTextPlugin, {
                                                ...
                                                placeholder: _jsx(Placeholder, { placeHolderText: placeHolderText }),
                                                ErrorBoundary: LexicalErrorBoundary
                                            }),
                                            _jsx(ListPlugin, {}),
                                            _jsx(HistoryPlugin, {}),
                                            _jsx(HtmlPlugin, { initialHtml: initialHtml, onBlur: onBlur, onChange: onChange }),
                                            _jsx(AutoLinkPlugin, {}),
                                            _jsx(LinkPlugin, {}),
                                            _jsx(LexicalClickableLinkPlugin, {}),
                                            _jsx(DisableEditorPlugin, { isDisable: isDisable }),
                                            _jsx(MarkdownShortcutPlugin, { transformers: TRANSFORMERS })
                                        ]
                                    }
                                )
                            )
