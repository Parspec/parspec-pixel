...
export const CenterTable = ({ table, sortableColumnIds }) => {
    return (_jsxs(MUITable, { children: [_jsx(TableHead, { children: table.getCenterHeaderGroups().map((headerGroup) => (_jsx(TableRow, { children: _jsx(_Fragment, { children: headerGroup.headers.map((header) => {
                            var _a;
