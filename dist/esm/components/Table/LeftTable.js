...
export const LeftTable = ({ table, sortableColumnIds }) => {
    var _a;
    return (_jsxs(MUITable, Object.assign({ style: { borderRight: '1px solid' } }, { children: [_jsx(TableHead, Object.assign({ style: { width: 'max-content' } }, { children: (_a = table === null || table === void 0 ? void 0 : table.getLeftHeaderGroups()) === null || _a === void 0 ? void 0 : _a.map((headerGroup) => (_jsx(TableRow, { children: headerGroup.headers.map((header) => {
                        var _a;
