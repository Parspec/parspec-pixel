...
export const LeftTable = ({ table, sortableColumnIds }) => {
    var _a;
    return (_jsxs(MUITable, Object.assign({ style: { borderRight: '1px solid grey' } }, { children: [_jsx(TableHead, Object.assign({ style: { width: 'max-content' } }, { children: (_a = table === null || table === void 0 ? void 0 : table.getLeftHeaderGroups()) === null || _a === void 0 ? void 0 : _a.map((headerGroup) => (_jsx(TableRow, { children: headerGroup.headers.map((header) => {
                        var _a;
                        return (_jsx(TableCell, Object.assign({ padding: header.column.id === 'select' ? 'checkbox' : 'normal', component: 'th', style: { border: '1px solid' }, colSpan: header.colSpan }, { children: header.isPlaceholder ? null : (_jsx(_Fragment, { children: header.column.id !== 'drag' && (_jsx(Box, Object.assign({ component: 'span', style: sortableColumnIds.includes(header.column.id) && header.column.getCanSort()
                                        ...
                                        : {}, onClick: sortableColumnIds.includes(header.column.id) ? header.column.getToggleSortingHandler() : () => { } }, { children: _jsxs(_Fragment, { children: [_jsx(BodyMedium, Object.assign({ fontWeight: 600, width: 'max-content' }, { children: flexRender(header.column.columnDef.header, header.getContext()) })), sortableColumnIds.includes(header.column.id)
                                                ? (_a = {
