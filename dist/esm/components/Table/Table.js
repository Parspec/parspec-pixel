...
export const Table = forwardRef((props, ref) => {
    ...
    const actionBegin = (e) => {
        ...
        if (
            ...
            !isNullOrUndefined(e.currentFilterObject) &&
            isNullOrUndefined((_a = e === null || e === void 0 ? void 0 : e.currentFilterObject) === null || _a === void 0 ? void 0 : _a.value)
        ) {
            e.cancel = true;
        }
            ...
            { position: 'relative', height: '100%', width: '100%', ref: tableContainerRef },
            {
                children: [
                                    ...
                                    children: [
                                        _jsxs(
                                            ...
                                            Object.assign(
                                                ...
                                                {
                                                    children: [
                                                        title && _jsx(BodySmall, Object.assign({ color: 'neutral.dark' }, { children: title })),
                                                                    ...
                                                                    { width: 300 },
                                                                    {
                                                                        children: _jsx(TextField, {
                                                                            ...
                                                                            InputProps: {
                                                                                startAdornment: _jsx(
                                                                                    InputAdornment,
                                                                                    Object.assign({ position: 'start' }, { children: _jsx(SearchIcon, { fontSize: 'small' }) })
                                                                                )
                                                                            },
                                                                            size: 'small',
                                                                            onChange: (t) => {
                                                                        ...
                                                                        children: _jsx(
                                                                            ...
                                                                            Object.assign(
                                                                                { 'data-testid': 'add-btn' },
                                                                                {
                                                                                    children: _jsx(
                                                                                        IconButton,
                                                                                        Object.assign({ onClick: () => onAdd() }, { children: _jsx(AddIcon, { fontSize: 'medium' }) })
                                                                                    )
                                                                                }
                                                                            )
                                                                        )
                                                                                ...
                                                                                { 'data-testid': 'move-btn' },
                                                                                {
                                                                                    children: _jsx(
                                                                                        ...
                                                                                        Object.assign(
                                                                                            ...
                                                                                            { children: _jsx(MoveDownIcon, { fontSize: 'medium' }) }
                                                                                        )
                                                                                    )
                                                                                }
                                                                            )
                                                        ...
                                                        (toolBarOptions === null || toolBarOptions === void 0 ? void 0 : toolBarOptions.includes('selectedItems')) &&
                                                            selected > 0 &&
                                                            !selectedItemsBelowSearch &&
                                                            _jsx(SelectedItemsCount, { count: selected, closeBanner: closeBanner })
                                                    ]
                                                }
                                            )
                                        ),
                                        _jsx(Box, { children: rightSection })
                                    ]
                                }
                            )
                        ),
                    (toolBarOptions === null || toolBarOptions === void 0 ? void 0 : toolBarOptions.includes('selectedItems')) &&
                        selected > 0 &&
                        selectedItemsBelowSearch &&
                        _jsx(Box, Object.assign({ mb: 2, width: 'max-content' }, { children: _jsx(SelectedItemsCount, { count: selected, closeBanner: closeBanner }) })),
                    _jsx(
                        Box,
                        Object.assign(
                                            ...
                                            children:
                                                ...
                                                _jsxs(
                                                    ...
                                                    Object.assign(
                                                        ...
                                                        {
                                                            children: [
                                                                _jsx(ColumnsDirective, { children: children }),
                                                                aggregateChildren && _jsx(AggregatesDirective, { children: aggregateChildren }),
                                                                _jsx(Inject, { services: [Freeze, RowDD, Selection, Sort, Edit, Page, ExcelExport, PdfExport, Resize, Filter, ContextMenu, Aggregate] })
                                                            ]
                                                        }
                                                    )
                                                )
