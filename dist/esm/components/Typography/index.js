...
export const H1 = (props) => _jsx(Heading, Object.assign({}, props, { variant: "h1", fontSize: '96px' }));
export const H2 = (props) => _jsx(Heading, Object.assign({}, props, { variant: "h2", fontSize: '60px' }));
export const H3 = (props) => _jsx(Heading, Object.assign({}, props, { variant: "h3", fontSize: '48px' }));
