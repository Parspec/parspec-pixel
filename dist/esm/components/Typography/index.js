...
export const H1 = (props) => _jsx(Heading, Object.assign({}, props, { variant: "h1", fontSize: '30px' }));
export const H2 = (props) => _jsx(Heading, Object.assign({}, props, { variant: "h2", fontSize: '28px' }));
export const H3 = (props) => _jsx(Heading, Object.assign({}, props, { variant: "h3", fontSize: '26px' }));
export const H4 = (props) => _jsx(Heading, Object.assign({}, props, { variant: "h4", fontSize: '24px' }));
export const H5 = (props) => _jsx(Heading, Object.assign({}, props, { variant: "h5", fontSize: '22px' }));
