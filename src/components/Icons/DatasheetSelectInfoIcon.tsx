import { getFillColor, SvgIcon, SvgIconProps } from './SvgIcon';
...
export const DatasheetSelectInfoIcon = ({ fontSize = 'xs', color }: SvgIconProps) => {
    ...
    return (
        <SvgIcon fontSize={fontSize} viewBox={`0 0 ${fontSize} ${fontSize}`} color="primary" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
