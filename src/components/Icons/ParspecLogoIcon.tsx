...
export const ParspecLogoIcon: React.FC<SvgIconProps> = ({ fontSize, sx }) => {
    return (
        <SvgIcon fontSize={fontSize} sx={sx} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
