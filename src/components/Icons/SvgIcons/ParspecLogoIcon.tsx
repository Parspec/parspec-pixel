import { SvgIcon, SvgIconProps, useGetFillColor } from '../SvgIcon';
    ...
    return (
        <SvgIcon fontSize={fontSize} viewBox={`0 0 36 36`} xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill={useGetFillColor(String(color))}
            />
            <path d="M28.5131 11.4891C27.4425 9.63209 25.9027 8.09003 24.0484 7.01789C22.1941 5.94576 20.0907 5.38132 17.9495 5.38132V17.5968L28.5131 11.4891Z" fill={useGetFillColor(String(color))} />
        </SvgIcon>
    );
};
