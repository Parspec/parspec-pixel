...
defaultModal.args = {
    open: false,
    children: <Typography.BodySmall>
      'Size of Modal Body is flexible, set height and width of children prop element',
...
customFooter.args = {
    ...
    header:
      ...
      <Typography.BodyMedium>Custom Modal</Typography.BodyMedium>
      </Box>,
    footer: 
    <Box textAlign={"right"}>
      <Button 
