...
export const RadioGroup = forwardRef<HTMLDivElement, RadioGroupProps>(({ options, label, name, size = 'small', error, helperText, isDisabled, ...rest }, ref) => (
    <FormControl error={error} ref={ref} disabled={isDisabled}>
