...
export default function ColorPicker({ color, onChange }: Readonly<ColorPickerProps>): JSX.Element {
    ...
    return (
        <Box className="color-picker-wrapper" width={WIDTH} height="306px" ref={innerDivRef}>
            ...
            <MoveWrapper className="color-picker-saturation" style={{ backgroundColor: `hsl(${selfColor.hsv.h}, 100%, 50%)` }} onChange={onMoveSaturation}>
                <Box
            ...
            <Box className="color-picker-color" style={{ backgroundColor: selfColor.hex }} />
        </Box>
    );
}
