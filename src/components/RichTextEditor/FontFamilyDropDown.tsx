...
export default function FontDropDown({ disabled = false, onChange, value }: { value: string; disabled?: boolean; onChange: (e: SelectChangeEvent<unknown>) => void }): JSX.Element {
    return (
        <Box width="124px">
