...
export const RightTable = (props: any) => {
    return (
        <table>
            <thead>
                {props?.table?.getRightHeaderGroups()?.map((headerGroup: any) => (
                                ...
                                <Draggable key={idx} draggableId={row.id} index={idx}>
                                    {(provided, snapshot) => (
                                        <tr key={row.id} ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps}>
                                            {row.getRightVisibleCells().map((cell: any) => {
            ...
            <tfoot>
                {props.table.getRightFooterGroups().map((footerGroup: any) => (
