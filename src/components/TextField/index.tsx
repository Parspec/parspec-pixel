...
export const TextField = forwardRef<HTMLDivElement, TextFieldProps>(({ variant, color, error, size, label, chips, onChipDelete, helperText, icon, startIcon, scrollAreaHeight, ...rest }, ref) => (
    <>
        <StyledMUITextField
            fullWidth
            label={label}
