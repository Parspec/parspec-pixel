...
export const H1: React.FC<HeadingTypographyProps> = (props) => <Heading {...props} variant="h1" fontSize={'30px'} />;
export const H2: React.FC<HeadingTypographyProps> = (props) => <Heading {...props} variant="h2" fontSize={'28px'} />;
export const H3: React.FC<HeadingTypographyProps> = (props) => <Heading {...props} variant="h3" fontSize={'26px'} />;
export const H4: React.FC<HeadingTypographyProps> = (props) => <Heading {...props} variant="h4" fontSize={'24px'} />;
export const H5: React.FC<HeadingTypographyProps> = (props) => <Heading {...props} variant="h5" fontSize={'22px'} />;
